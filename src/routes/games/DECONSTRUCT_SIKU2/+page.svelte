<script lang="ts">
  ...
  const markup = `<canvas id="three-canvas"></canvas>
...
<div id="lobby">
    <div class="lobby-box">
        ...
        <div id="lobby-waiting" style="display:none;">
            ...
            <button id="start-btn" style="margin-top:14px;" onclick="window.hostStartNow()">BEGIN TRANSMISSION</button>
...
<div id="ui-overlay" class="hidden">
    ...
    <div id="side-panel">
        ...
        <button id="resolve-btn" disabled onclick="window.onPickCard()">TRANSMIT</button>
    </div>
</div>`;
